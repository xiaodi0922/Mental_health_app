...
import 'package:mental_heatlh_app/components/Stress_Energy_BottomSheet.dart';
import 'package:mental_heatlh_app/components/Stress_Energy_Dialog.dart';
              ...
              GestureDetector(
                onTap: () async {
                  final result = await showModalBottomSheet<Map<String, double>>(
                    ...
                    builder: (context) => StressEnergyBottomSheet(),
                  );

                  if (result != null) {
                    setState(() {
                      stressLevel = result['stress']!;
                      energyLevel = 100 - result['stress']!;
                    });
                  }
                },
                child: Container(
