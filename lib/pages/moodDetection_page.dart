...
class _MoodDetectionPageState extends State<MoodDetectionPage> {
  ...
  final List<String> _textMoods = ["Awful", "Sad", "Neutral", "Good", "Great"];
  @override
  void initState() {
    super.initState();
        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "Your Mood: ${_textMoods[_sliderValue.toInt()]}",
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Image.asset(
                        _moodImages[_sliderValue.toInt()],
                        width: 100,
                        height: 100,
                      ),
                      Slider(
